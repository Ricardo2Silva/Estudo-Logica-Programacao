// crie uma funçao que receba um numero e a partir desse numero, exiba a tabuada do numero 1 até o escolhido;


let buildMultiplicationTable = number => {
    let multiplier = [];
    let numbers = [];
    let index = 0;
    while (index <= 10){
 ...
 console.log(buildMultiplicationTable(15))
